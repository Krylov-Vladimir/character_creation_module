...
def attack(char_name: str, char_class: str) -> str:
    """Выполняет функцию вычисления урона при атаке."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет степень защиты при атаке."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет степень применения специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Присваивает значение персонажа.Активирут режим тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выводит пояснения персонажа в зависмсти от выбора."""
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> None:
    """Вызывает приветствие запускает игру."""
